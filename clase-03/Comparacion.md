...
class SistemaUniversitario {
    ...
    constructor() {
        console.log("Sistema universitario iniciado");
    }
    ...
    procesarPago(estudianteId: number, monto: number, metodo: string) {
        ...
        // ❌ VIOLACIÓN DIP: Manejo directo de Array
        this.pagos.push({
...
// - SRP: 5+ responsabilidades
// - OCP: Condicionales hardcodeados en procesarPago()
// - DIP: Depende de Array concreto
// - ISP: Interfaz implícita gigante
// - LSP: No aplica explícitamente (sin herencia)
```
